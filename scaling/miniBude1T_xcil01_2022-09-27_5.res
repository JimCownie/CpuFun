#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=12  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664279402, formatted: "Tue Sep 27 11:50:02 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [12944.1,12945.3,12945.3,12943.7,12944.4,12945.9,12946.1,12946,12945,12943.1]
    context_ms:          10.738191
    sum_ms:              103559.525
    avg_ms:              12944.941
    min_ms:              12943.109
    max_ms:              12946.082
    stddev_ms:           1.046
    giga_interactions/s: 0.123
    gflop/s:             4.942
    gfinst/s:            3.087
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 12943.11, max_ms: 12946.08, sum_ms: 103559.53, avg_ms: 12944.94, ppwi: 1, wgsize: 1 }
