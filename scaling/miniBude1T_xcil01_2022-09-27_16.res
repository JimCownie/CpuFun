#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=56  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664280055, formatted: "Tue Sep 27 12:00:55 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [2775.16,2774.91,2774.95,2774.87,2774.73,2774.95,2774.72,2774.66,2774.44,2774.83]
    context_ms:          13.825811
    sum_ms:              22198.151
    avg_ms:              2774.769
    min_ms:              2774.444
    max_ms:              2774.953
    stddev_ms:           0.159
    giga_interactions/s: 0.576
    gflop/s:             23.053
    gfinst/s:            14.400
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 2774.44, max_ms: 2774.95, sum_ms: 22198.15, avg_ms: 2774.77, ppwi: 1, wgsize: 1 }
