#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=52  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664280025, formatted: "Tue Sep 27 12:00:25 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [2986.54,2987.68,2986.58,2987.49,2986.94,2986.33,2986.93,2985.29,2987.4,2987.41]
    context_ms:          13.275107
    sum_ms:              23894.373
    avg_ms:              2986.797
    min_ms:              2985.294
    max_ms:              2987.490
    stddev_ms:           0.688
    giga_interactions/s: 0.535
    gflop/s:             21.417
    gfinst/s:            13.378
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 2985.29, max_ms: 2987.49, sum_ms: 23894.37, avg_ms: 2986.80, ppwi: 1, wgsize: 1 }
