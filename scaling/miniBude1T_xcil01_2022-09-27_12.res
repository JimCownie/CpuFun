#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=40  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664279918, formatted: "Tue Sep 27 11:58:38 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [3878.61,3878.46,3878.56,3878.6,3878.46,3878.43,3878.25,3878.44,3878.45,3878.3]
    context_ms:          11.982953
    sum_ms:              31027.474
    avg_ms:              3878.434
    min_ms:              3878.249
    max_ms:              3878.605
    stddev_ms:           0.111
    giga_interactions/s: 0.412
    gflop/s:             16.493
    gfinst/s:            10.302
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 3878.25, max_ms: 3878.60, sum_ms: 31027.47, avg_ms: 3878.43, ppwi: 1, wgsize: 1 }
