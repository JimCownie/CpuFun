#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=4  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664278820, formatted: "Tue Sep 27 11:40:20 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [38771.1,38770.3,38770.5,38770.6,38772.7,38771.4,38770.1,38773.3,38771.8,38770.8]
    context_ms:          11.776132
    sum_ms:              310171.228
    avg_ms:              38771.403
    min_ms:              38770.067
    max_ms:              38773.303
    stddev_ms:           1.071
    giga_interactions/s: 0.041
    gflop/s:             1.650
    gfinst/s:            1.031
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 38770.07, max_ms: 38773.30, sum_ms: 310171.23, avg_ms: 38771.40, ppwi: 1, wgsize: 1 }
