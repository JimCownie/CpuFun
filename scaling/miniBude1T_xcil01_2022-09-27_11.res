#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=36  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664279875, formatted: "Tue Sep 27 11:57:55 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [4308.19,4307.94,4308.04,4308.13,4308.01,4307.8,4308.3,4307.94,4308.22,4307.72]
    context_ms:          12.054994
    sum_ms:              34464.155
    avg_ms:              4308.019
    min_ms:              4307.717
    max_ms:              4308.296
    stddev_ms:           0.186
    giga_interactions/s: 0.371
    gflop/s:             14.848
    gfinst/s:            9.275
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 4307.72, max_ms: 4308.30, sum_ms: 34464.15, avg_ms: 4308.02, ppwi: 1, wgsize: 1 }
