#  TARGET_MACHINE='ThunderX2 99xx' OMP_NUM_THREADS=28  KMP_HW_SUBSET=1T KMP_AFFINITY='compact,granularity=fine' ./omp-bude
miniBUDE:  
compile_commands:
...
host_cpu:
  ~
time: { epoch_s:1664279771, formatted: "Tue Sep 27 11:56:11 2022 GMT" }
deck:
  path:         "../data/bm1"
  poses:        65536
  proteins:     938
...
results:
  - outcome:             { valid: true, max_diff_%: 0.002 }
    ...
    raw_iterations:      [5542.16,5542.63,5543.34,5543.87,5543.09,5543.69,5542.41,5542.56,5542.35,5542.65]
    context_ms:          11.294295
    sum_ms:              44343.960
    avg_ms:              5542.995
    min_ms:              5542.346
    max_ms:              5543.874
    stddev_ms:           0.553
    giga_interactions/s: 0.288
    gflop/s:             11.540
    gfinst/s:            7.209
    energies:            
      - 865.52
      ...
      - 33.95
      - 135.59
best: { min_ms: 5542.35, max_ms: 5543.87, sum_ms: 44343.96, avg_ms: 5542.99, ppwi: 1, wgsize: 1 }
